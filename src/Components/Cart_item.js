            ...
            <div className="qty-container">
               <div className="options vertical">
                  <Options
                     ...
                     src={
                        "https://image.flaticon.com/icons/svg/1237/1237946.svg"
                     }
                     alt={"increment"}
                     style={{ height: 1 + "em" }}
                  ></Options>
                  ...
                  <Options
                     ...
                     src={
                        "https://image.flaticon.com/icons/svg/1828/1828901.svg"
                     }
                     alt={"decrement"}
                     style={{ height: 1 + "em" }}
                  ></Options>
               ...
               <div style={{ margin: "5px" }}>
                  Total Cost :{" "}
                  {this.props.cart.qty * this.props.cart.product.product_price}
               </div>
            </div>
         </div>
      );
